...
class Simulation:
    ...
    def sanity_check(self):
        ...
        # check neff_resol
        if self.neff_resolution is not None and self.k_parallel is "default":
        ...
        # check neff_imag
        if self.neff_imag is not None and self.k_parallel is "default" and self.neff_waypoints is None:
