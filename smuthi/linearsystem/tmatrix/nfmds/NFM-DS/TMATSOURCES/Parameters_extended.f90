! This file is identical to Parameters.f90, but O was changed to kind(1.q0)
! which enables quad precision. Rename this file to "Parameters.f90" and compile
! to get extended precision binary
module parameters
  implicit none
